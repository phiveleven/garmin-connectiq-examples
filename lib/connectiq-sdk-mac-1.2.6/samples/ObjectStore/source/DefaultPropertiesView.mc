...
class DefaultPropertiesView extends Ui.View
{
    ...
    function onUpdate(dc)
    {
        ...
        dc.drawText(3, 125, Gfx.FONT_SMALL, "Default properties can't be cleared", Gfx.TEXT_JUSTIFY_LEFT);
        dc.drawText(3, 107, Gfx.FONT_SMALL, "Edit these via Express/GCM", Gfx.TEXT_JUSTIFY_LEFT);
