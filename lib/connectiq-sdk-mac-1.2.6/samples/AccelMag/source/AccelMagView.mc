...
class AccelMagView extends Ui.View
    {
    const r = 10;
    const incrFrict = 15;
    const pcntFrict = 99;
    ...
    function onUpdate(dc) {
        ...
        if( mag != null )
        {
            dc.drawText( width / 2, height - 63, Gfx.FONT_TINY, "Mx = " + mag[0], Gfx.TEXT_JUSTIFY_CENTER );
            dc.drawText( width / 2, height - 43, Gfx.FONT_TINY, "My = " + mag[1], Gfx.TEXT_JUSTIFY_CENTER );
            dc.drawText( width / 2, height - 23, Gfx.FONT_TINY, "Mz = " + mag[2], Gfx.TEXT_JUSTIFY_CENTER );
        }
        else
        {
            dc.drawText( width /2, height - 20, Gfx.FONT_TINY, "no Mag", Gfx.TEXT_JUSTIFY_CENTER );
        }
